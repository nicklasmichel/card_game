...
class SpellEffect(Enum):
    ...
    GRANT_ATTACK_BONUS_TO_ATTACKER_THIS_COMBAT = "Angreifer f?r diesen Kampf verst?rken"
    ...
    BUFF_ATTACKERS_DICE_THIS_TURN = "Angreifer erhalten W?rfelbonus"
    ...
    MODIFY_DIE_RESULT = "W?rfelergebnis ver?ndern"
    ...
    RETALIATE_DICE_DAMAGE = "Vergeltung nach W?rfelschaden"
    RETURN_OWN_FIGHTING_CREATURE_TO_HAND = "Eigene kaempfende Kreatur auf die Hand"
    REROLL_OPEN_DIE = "Offenen W?rfel neu werfen"
...
class ReactionTrigger(Enum):
    ...
    AFTER_DICE_REVEALED = "W?rfel wurden geworfen"
    BEFORE_DICE_COMPARISON = "Ausgew?hlte W?rfel warten auf Auswertung"
    AFTER_DICE_COMPARISON = "W?rfelvergleich wurde abgeschlossen"
    ...
    OWN_CREATURE_DAMAGED_IN_DICE_COMPARISON = "Eigene Kreatur erlitt Schaden in einem W?rfelvergleich"
