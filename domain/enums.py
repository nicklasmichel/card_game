...
class SpellEffect(Enum):
    ...
    REROLL_OWN_UNUSED_COMBAT_DIE = "Eigenen unbenutzten Kampfwuerfel neu werfen"
    ADD_TWENTY_TO_OWN_UNUSED_COMBAT_DIE = "Eigenen unbenutzten Kampfwuerfel erhoehen"
...
class ReactionTrigger(Enum):
    ...
    AFTER_DICE_REVEALED = "Wuerfel wurden aufgedeckt"
