...
class PlaytestReportTests(unittest.TestCase):
    def test_analyzes_only_latest_game_including_aborted_session(self) -> None:
        lines = [
            ...
            "Player 1 creates Creature 4 (A 2 / D 1 / DMG 3 / Life 2 / Trample + Haste) for 5 resource(s).",
            "Player 2 creates Creature 5 (A 1 / D 4 / DMG 1 / Life 1 / Flying) for 3 resource(s).",
            "[COMBAT ATTACKERS] turn=7 player=Player_1 creatures=Creature_4",
            "Turn 8: Player 2 is active.",
            "Player 2 creates Creature 6 (A 1 / D 2 / DMG 2 / Life 1 / Vigilance + Haste) for 3 resource(s).",
